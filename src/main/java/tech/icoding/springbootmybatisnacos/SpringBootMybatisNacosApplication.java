package tech.icoding.springbootmybatisnacos;
...
@Slf4j
public class SpringBootMybatisNacosApplication {

	@SneakyThrows
	public static void main(String[] args) {
		final ConfigurableApplicationContext application = SpringApplication.run(SpringBootMybatisNacosApplication.class, args);
